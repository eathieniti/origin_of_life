...
def energy_f(lat):
    H_lat = (-1. * (
             ...
             -1. * (
                     ((lat[1:39, 1:39]==1) + (lat[1:39, 1:39]==3))*(lat[0:38, 1:39]==0) + 
                     ((lat[1:39, 1:39]==2) + (lat[1:39, 1:39]==4))*(lat[2:40, 1:39]==0)
                   ) + 
             1. * (
                     ((lat[1:39, 1:39]==1) + (lat[1:39, 1:39]==3))*((lat[0:38, 1:39]==1) + (lat[0:38, 1:39]==3)) + 
                     ((lat[1:39, 1:39]==2) + (lat[1:39, 1:39]==4))*((lat[2:40, 1:39]==2) + (lat[2:40, 1:39]==4))
                  ) +
             -1. * (
                     ((lat[1:39, 1:39]==1) + (lat[1:39, 1:39]==2))*(lat[1:39, 2:40]==0) +
                     ((lat[1:39, 1:39]==3) + (lat[1:39, 1:39]==4))*(lat[1:39, 0:38]==0)
                   ) + 
             1. * (
                     ((lat[1:39, 1:39]==1) + (lat[1:39, 1:39]==2))*((lat[1:39, 2:40]==1) + (lat[1:39, 2:40]==2)) +
                     ((lat[1:39, 1:39]==3) + (lat[1:39, 1:39]==4))*((lat[1:39, 0:38]==3) + (lat[1:39, 0:38]==4))
                  ))
    return np.sum(H_lat)
